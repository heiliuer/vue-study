...
+ function($) {
  ...
  $.openModal = function(tpl, onOpen) {
    ...
    dialog.addClass("weui-dialog__visible");
  ...
  $.closeModal = function() {
    ...
    $(".weui-dialog__visible").removeClass("weui-dialog__visible").transitionEnd(function() {
      $(this).remove();
    });
  };
...
+ function($) {
  ...
  $.toast = function(text, style, callback) {
    ...
    show('<i class="weui-icon_toast"></i><p class="weui-toast_content">' + (text || "已经完成") + '</p>', className);
  ...
  $.showLoading = function(text) {
    var html = '<i class="weui-loading weui-icon_toast"></i>';
...
+ function($) {
  ...
  var show = function(params) {
    ...
    var actionsHtml = actions.map(function(d, i) {
      return '<div class="weui-actionsheet_cell ' + (d.className || "") + '">' + d.text + '</div>';
    }).join("");

    var titleHtml = "";

    if (params.title) {
      titleHtml = '<div class="weui-actionsheet_title">' + params.title + '</div>';
    }

    var tpl = '<div class="weui-actionsheet " id="weui-actionsheet">'+
                titleHtml +
                '<div class="weui-actionsheet_menu">'+
                actionsHtml +
                '</div>'+
                '<div class="weui-actionsheet_action">'+
                  '<div class="weui-actionsheet_cell weui-actionsheet_cancel">取消</div>'+
                  '</div>'+
                '</div>';
    var dialog = $(tpl).appendTo(document.body);

    dialog.find(".weui-actionsheet_menu .weui-actionsheet_cell, .weui-actionsheet_action .weui-actionsheet_cell").each(function(i, e) {
      $(e).click(function() {
        $.closeActions();
...
+function ($) {
  ...
  var showTab = function(a) {
    ...
    var bd = $a.parents(".weui-tab").find(".weui-tab_bd");

    bd.find(".weui-tab_bd_item_active").removeClass("weui-tab_bd_item_active");

    $(href).addClass("weui-tab_bd_item_active");
  }

  $.showTab = showTab;

  $(document).on("click", ".weui-tabbar_item, .weui-navbar_item", function(e) {
...
+ function($) {
  ...
  $(document).on("click", ".weui-search_bar label", function(e) {
    $(e.target).parents(".weui-search_bar").addClass("weui-search_focusing");
  })
  .on("blur", ".weui-search_input", function(e) {
    var $input = $(e.target);
    if(!$input.val()) $input.parents(".weui-search_bar").removeClass("weui-search_focusing");
  })
  .on("click", ".weui-search_cancel", function(e) {
    var $input = $(e.target).parents(".weui-search_bar").removeClass("weui-search_focusing").find(".weui-search_input").val("").blur();
  })
  .on("click", ".weui-icon_clear", function(e) {
    var $input = $(e.target).parents(".weui-search_bar").find(".weui-search_input").val("").focus();
  });
      ...
      '<div class="weui-cells weui-cells_radio">\
        ...
        <label class="weui-cell weui-check_label" for="weui-select-id-{{this.title}}">\
          ...
          <div class="weui-cell_ft">\
            ...
            <span class="weui-icon_checked"></span>\
          </div>\
        </label>\
        {{/items}}\
      </div>',
